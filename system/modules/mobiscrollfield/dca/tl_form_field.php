 ...
 * @version    $Id: config.php 001 2012-04-24 09:00:00V wreiter $
 */
 ...
 * Config
 */
$GLOBALS['TL_DCA']['tl_form_field']['config']['onload_callback'][] = array('tl_form_field_mobiscroll', 'adjustFields');


/**
 * Palettes
 */
$GLOBALS['TL_DCA']['tl_form_field']['palettes']['calendar_mobil'] = '{type_legend},type,name,label;{fconfig_legend},mandatory,rgxp,maxlength,dateFormat,dateDirection;{expert_legend:hide},value,dateParseValue,class,accesskey;{submit_legend},addSubmit';
...
class tl_form_field_mobiscroll extends Backend
{
	public function adjustFields($dc)
	{
		if ($this->Input->get('act') == 'edit')
		{
			...
			if ($objField->type == 'calendar_mobil')
			{
